...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param({1,2,3}, 2,  None,id="violation 1+2 lines changed, and unrelated"),
        ...
        pytest.param({3}, 2,  {"E1","E2"},id="unrelated line changed, always fail on E1,E2"),
        pytest.param({1,2}, 2,  {"E1","E2"},id="1+2 lines changed, always fail on E1,E2"),
    ],
)
def test_filter_violations(
    modified_lines: set[int], expected_violation_count: int, always_fail_on:set[str] | None
) -> None:
    violations = [
        Violation(
            error_code="E1",
